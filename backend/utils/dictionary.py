...
from utils.youdao import translate_to_chinese
...
def lookup_word(word: str) -> dict | None:
    """
    用 Free Dictionary API 拿词性/释义/音标结构，释义文本再调有道翻译成中文。
    返回结构：{"word": str, "meaning": [{"type": str, "content": str}], "en_pronunciation": str, "us_pronunciation": str}
    查不到时返回 None
    """
